...
const DocumentUpload: React.FC = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', height: '100vh', background: '#f4f4f9', padding: '20px', width: '100vw' }}>
      <div style={{ background: 'white', padding: '30px', borderRadius: '10px', boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.1)', width: '80%', maxWidth: '600px', textAlign: 'center', marginBottom: '20px' }}>
